...
const fetchProducts=asyncHandler(async(req,res)=>{
    try {
        ...
        res.json({products,page:1,pagees:Math.ceil(count/pagesize),hasMore:false})

    } catch (error) {
        console.error(error)
        res.status(500).json({error:"Serevr Eroor"})
    }
})
...
const fetchProductById=asyncHandler(async(req,res)=>{
    try {
        ...
        // const product=await Product.findById('65ec3e8dcd7a728a306749c9')
