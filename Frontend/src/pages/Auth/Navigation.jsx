...
import { useLogoutMutation } from "../../redux/Api/userApiAlice"
import {logout} from '../../redux/featires/auth/authSlice'
...
export const Navigation = () => {
   ...
   const [logoutApiCall]=useLogoutMutation();// I Have doubt here why logoutApiCall??

    // const[Logout,{isLoading}]=useLogoutMutation();// anotherway of doing same

    const logoutHandler=async()=>{
        try {
            await logoutApiCall().unwrap();// Another wauy of doing same
            // await Logout().unwrap();
            dispatch(logout())
            navigate('/login')
        } catch (error) {
